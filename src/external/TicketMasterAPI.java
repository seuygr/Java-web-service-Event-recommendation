...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "xpgcnGwHxlzZ1GH4TUhDQNQGtIuC7jm4";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			// Send request to TicketMaster and get response code could be returned directly response body is saved in inputStream of connection
	...
	public static void main(String[] args) {
		...
		tmApi.queryAPI(32.877564, -117.211375);
	}
}
